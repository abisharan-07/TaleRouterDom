                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-sm-6">
                                    <div className="service-item">
                                        <div className="icon">
                                            <img src={service_1} alt="discover SEO" className="templatemo-feature" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-sm-6">
                                    <div className="service-item">
                                        <div className="icon">
                                            <img src={service_2} alt="data analysis" className="templatemo-feature" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-sm-6">
                                    <div className="service-item">
                                        <div className="icon">
                                            <img src={service_3} alt="precise data" className="templatemo-feature" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-sm-6">
                                    <div className="service-item">
                                        <div className="icon">
                                            <img src={service_4} alt="SEO marketing" className="templatemo-feature" />
                                        </div>
