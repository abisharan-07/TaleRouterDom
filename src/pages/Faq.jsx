...
import service_1 from "../assets/images/services-01.jpg";
import service_2 from "../assets/images/services-02.jpg";
import service_3 from "../assets/images/services-03.jpg";
import service_4 from "../assets/images/services-04.jpg";
                            ...
                            <div className="steps">
                                <div className="row">
                                    <div className="col-lg-3">
                                        <div className="item">
                                            <img src={service_1} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto", }} />
                                            <h4>Project Introduction</h4>
                                        </div>
                                    </div>
                                    <div className="col-lg-3">
                                        <div className="item">
                                            <img src={service_2} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto", }} />
                                        </div>
                                    </div>
                                    <div className="col-lg-3">
                                        <div className="item">
                                            <img src={service_3} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto", }} />
                                            <h4>Data Analysis</h4>
                                        </div>
                                    </div>
                                    <div className="col-lg-3">
                                        <div className="item last-item">
                                            <img src={service_4} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto", }} />
